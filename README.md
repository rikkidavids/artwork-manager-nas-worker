...
Build 5.46 fixes mixed-album status priority so missing tracks, unreadable files, conversion issues, and shape problems are not hidden by a good-size example cover.
