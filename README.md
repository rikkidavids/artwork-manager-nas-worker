...
Build 5.45 improves live feedback while the NAS is scanning, searching, embedding, restoring, or repairing, and adds a quick Copy Path action for browser-based checking.
