...
Build 5.47 refreshes album rows from fresh file checks, keeps mixed-track problems ahead of size-only labels, and fixes artwork inspector fit on small screens.
