...
Build 5.29 keeps the web UI steady during hands-on review: clearer empty search results, cleaner modal focus, and less ambiguous artwork preview controls.
