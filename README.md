...
Build 5.27 polishes the web workbench for tablet and phone, keeps artwork inspection inside the visible screen, shortens queue status wording, and warns before embedding weak replacement covers.
