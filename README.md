...
Build 5.32 adds web diagnostics and Maintenance tools for cleaning stale saved artwork options and repairing queue status after setting or file changes.
