...
Build 5.13 restores the simpler two-pane NAS web workbench: queue on the left, artwork and album detail on the right, with compact top controls and the settings screen from 5.11. Provider search and browser-based approve/embed are the next migration step.
