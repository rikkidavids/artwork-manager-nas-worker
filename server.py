...
UPDATE_HINT = (
    ...
    'an older cached Docker image/container. Pull the latest GHCR image and recreate the container. Build 5.21 keeps artwork panels steady while covers load and fits previews inside the inspector.'
)
