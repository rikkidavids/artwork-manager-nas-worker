...
UPDATE_HINT = (
    ...
    'an older cached Docker image/container. Pull the latest GHCR image and recreate the container. Build 5.37 can trigger Watchtower immediately after GitHub publishes a new image.'
)
