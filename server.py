...
UPDATE_HINT = (
    ...
    'an older cached Docker image/container. Pull the latest GHCR image and recreate the container. Build 5.40 tightens the responsive web layout for iPad and iPhone Safari.'
)
