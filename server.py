...
UPDATE_HINT = (
    ...
    'an older cached Docker image/container. Pull the latest GHCR image and recreate the container. Build 5.38 keeps the review layout stable while artwork loads and fixes full-cover inspection.'
)
