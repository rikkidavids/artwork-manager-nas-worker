...
UPDATE_HINT = (
    ...
    'an older cached Docker image/container. Pull the latest GHCR image and recreate the container. Build 5.39 adds Fit/Actual Size artwork inspection and smoother review handoff.'
)
